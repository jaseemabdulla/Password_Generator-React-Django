...
function App() {
  ...
  const handleEmailSubmit = (event) => {
    ...
    const emailApiUrl = "send_password_to_email/";
  ...
  const generatePassword = () => {
    const apiUrl = "generate_password/";

    const requestData = {
      length: passwordLength,
      choice: Object.keys(checkboxValues).filter(
    ...
    <>
      <div className="bg-slate-500 flex items-center justify-center h-screen">
        <div className="bg-slate-800 p-8 rounded-lg shadow-2xl max-w-md w-full mx-4">
          ...
          <p className="text-base mb-4 font-normal text-gray-200 lg:text-base dark:text-gray-400">
          ...
          <div className="mb-4">
            ...
            >
              Password Length{" "}
              <span className="bg-gray-600 p-1 rounded-md">
                {passwordLength}
              </span>
            </label>
            <input
              ...
              className="slider w-full h-2 bg-gray-500 rounded-full appearance-none"
            />
          </div>
          ...
          <form onSubmit={handleEmailSubmit}>
            <div className="mb-4">
              <input
                ...
                className="border rounded-md mb-2 w-full py-2 px-3 bg-blue-100 text-black"
                required
              />
